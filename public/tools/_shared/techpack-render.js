...
(function () {
  ...
  // Standard-Measurements pro Garment. Anzahl entspricht den nummerierten Pfeilen
  // auf der jeweiligen measured-JPG. User füllt cm-Werte ein.
  function _gen(n) {
    var out = [];
    for (var i = 1; i <= n; i++) out.push({ name: '' });
    return out;
  }
  var STANDARD_MEASUREMENTS = {
    ...
    tank:          _gen(8),
    longsleeve:    _gen(13),
    'summer-sleeve': _gen(11),
    crewneck:      _gen(11),
    hoodie:        _gen(11),
    zipper:        _gen(11),
    'jogger-cuffed': _gen(8),
    'jogger-open': _gen(8),
    shorts:        _gen(7),
    'cap-normal':  _gen(5),
    'cap-trucker': _gen(5),
